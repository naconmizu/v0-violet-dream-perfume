...
const goldFragrances = [
  {
    name: "Ouro Solar",
    description: "Ilumina com bergamota italiana, pimenta rosa cintilante e âmbar luminoso para um rastro radiante.",
  ...
  {
    name: "Mel de Safra",
    description: "Combina mel de acácia, flor de laranjeira e sândalo creme, evocando calor artesanal.",
  ...
  {
    name: "Âmbar Aurora",
    description: "Âmbar resinosa e fava tonka ganham brilho com notas de figo dourado e incenso branco.",
  ...
  },
  {
    ...
    description: "Pera cristalina, champanhe rose e almiscar cremoso criam um perfume festivo e elegante.",
    highlight: "Efervescente suave",
    essences: ["Pera Cristal", "Champanhe Rose", "Almiscar Cremoso"],
  ...
  },
  {
    ...
    highlight: "Oriental quente",
    essences: ["Damasco Maduro", "Acafrao", "Sandalo Leitoso"],
    color: "from-[#e8b954] via-[#c4852e] to-[#7a4a12]",
  ...
  },
  {
    ...
    highlight: "Aveludado feminino",
    essences: ["Pessego Branco", "Heliotropio", "Baunilha Tonka"],
    color: "from-[#f5c889] via-[#e09952] to-[#9e6326]",
...
const goldEssences = [
  {
    ...
    description: "Explosão cítrica com óleos essenciais prensados a frio que abrem a pirâmide com sofisticação.",
  },
  {
    name: "Mel de Acácia",
    description: "Doçura translúcida e floral que adiciona textura cremosa sem pesar a composição.",
  },
  {
    name: "Flor de Laranjeira",
    description: "Essência solar com facetadas nuances melífluas e toque levemente verde.",
  },
  {
    name: "Sândalo Creme",
    description: "Madeira envolvente e macia que prolonga o rastro com sensação aveludada.",
  },
  {
    name: "Âmbar Vivo",
    description: "Acorde âmbarado moderno com brilho metálico, ideal para bases luxuosas.",
  },
  {
    name: "Champanhe Rosé",
    description: "Notas espumantes e frutadas que trazem leveza glamourosa à coleção.",
  },
]
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <p className="uppercase tracking-[0.45em] text-xs text-yellow-200/70 mb-4">Golden Aura Edition</p>
          ...
          <p className="text-lg text-white/80">
            Fragrâncias banhadas por luz líquida: camadas de especiarias solares, madeiras melífluas e acorde champanhe
            para experiências olfativas exuberantes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {goldFragrances.map((fragrance) => (
            <Link key={fragrance.name} href={`/fragrancia/${fragrance.slug}`}>
              <Card className="group overflow-hidden border border-white/10 bg-white/5 backdrop-blur-sm hover:border-yellow-500/30 hover:bg-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-500/10 hover:-translate-y-2 cursor-pointer">
                <div className={`relative aspect-[4/5] bg-gradient-to-br ${fragrance.color} overflow-hidden`}>
                  ...
                  <div className="absolute top-4 right-4 text-xs uppercase tracking-[0.35em] text-white/65">Aurum</div>
                  <div className="absolute bottom-6 left-6">
                    <p className="text-xs text-white/65 uppercase tracking-[0.35em]">Notas principais</p>
                ...
                <CardContent className="p-6 bg-gradient-to-b from-white/10 to-transparent">
                  <h4 className="text-2xl font-serif text-white mb-3 group-hover:text-yellow-200 transition-colors duration-300">
                    {fragrance.name}
                  </h4>
        ...
        <div>
          <div className="text-center mb-12">
            <p className="text-xs uppercase tracking-[0.45em] text-yellow-100/70 mb-3">Essências Douradas</p>
            <h4 className="text-3xl font-serif text-white">Ingredientes assinatura</h4>
          </div>
